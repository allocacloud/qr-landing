        ...
        if (!app.api) {
            app.api = {
                ...
                createTask: data =>
                    new Promise(async (resolve, reject) => {
                        try {
                            const { company_id, service_id, user_name, user_login, description, anonymous, lng, files } = data

                            return request.post(app.config.api.host + "/CompanyBpServicesQRList", {
                                json: {
                                    company_id,
                                    service_id,
                                    user_name,
